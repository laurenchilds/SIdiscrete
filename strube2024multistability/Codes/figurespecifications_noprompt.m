...
%   INPUT:
%   ------
%   - none. All specifications must be hardcoded below
%
%   OUPUT:
%   ------
%   - user-specified figures specifications as hardcoded below
%
%   DEPENDENCIES:
%   -------------
%   - None
...
if generatefigures==1
    ...
    %Would you like to create any Trajectory Plots? Y=1/N=0> 
     ...
     %This script should not be used for batch run figures
