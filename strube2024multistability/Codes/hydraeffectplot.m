...
%       (1) plottype='BinaryHydra'
%       Binary Hydra Effect -- with disease population size is or is
%       not above the disease-free population by a factor of "threshold". 
%       (2) plottype='LinearScaleHydra'
%       Linear-Scale Hydra Effect -- With-disease population size
...
%           ("threshold"=0).
%       (3) plottype='FoldChangeHydra' 
%       Fold-Change Hydra Effect -- Log2 of with-disease population 
...
%   INPUTS:
%   -------
%   plottype            : figure type choice [string]
%   HydraArray          : Array of data generated by "calculatehydra.m"
%   threshold           : hydra effect threshold [scalar]
%   increm1             : increments of the first bifurcation parameter
%                         [vector]
%   increm2             : increments of the second bifurcation parameter
%                         [vector]
%   bifpar1             : name of the first bifurcation parameter
%                         [string]
%   bifpar2             : name of the second bifurcation parameter
%                         [string]
%   bp1label            : latex formatted name of the 1st bif parameter
%                         [string]
%   bp2label            : lated formatted name of the 2nd bif parameter
%                         [string]
%   colorbarlabel       : colorbar label [string]
%   figuretitle         : figure title [string]
%   oldfigurecounter    : qty of generated figures prior to use of this
%   function
%
%   OUTPUTS:
%   --------
%   figurehandle        :
%   figurecounter       : qty of generated figures use of this function
%
%   DEPENDENCIES: 
%   -------------
