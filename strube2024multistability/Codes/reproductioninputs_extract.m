...
%%  SCRIPT DESCRIPTION
%==========================================================================
%   Extracts simulation conditions from a data structure
%   created by either
%   
...
%   INPUTS:
%   -------
%   batchdisplay    : [scalar] batch run in progress = 1, otherwise = 0
...
%==========================================================================
%
%   - Changed the variable "date" to "captureddate" to avoid confusion with
%   the MATLAB variable of the same name.
%
%
%% ------------------------------------------------------------------------
%==========================================================================
...
%% (I) PRINT DESCRIPTION OF REPRODUCTION RUN TO THE COMMAND LINE 
    ...
    if batchdisplay==1
        fprintf('\n\nA complete description of initial conditions and model parameters used to generate this figure')
        fprintf('\ncan be viewed by loading the called .mat file in MATLAB\n\n.')
    else
...
%% (II) EXTRACT RUN CONDITIONS 
    captureddate=ReproductionInputs.RunDate;
